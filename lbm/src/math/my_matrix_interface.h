...
public:
	...
	virtual std::vector<T> GetRow(int const y) const = 0;
	...
	virtual void SetRow(int const y, std::vector<T> const & row) = 0;
	...
	virtual std::vector<T> GetColumn(int const x) const = 0;
	...
	virtual void SetColumn(int const x, std::vector<T> const & coll) = 0;
